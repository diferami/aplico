...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-11-2017 a las 20:30:08
...
--
CREATE DATABASE IF NOT EXISTS `aplico` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `aplico`;
...
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=5816 ;
